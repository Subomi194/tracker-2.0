  ...
  return (
    <section className="bg-cream py-24 px-6 font-['DM_Sans']">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <Link
          href="/register"
          className="bg-rose-deep text-cream px-10 py-4 rounded-full font-semibold text-base hover:bg-[#3d2b6e] transition-all hover:shadow-2xl hover:shadow-[#2d1b4e]/20 hover:-translate-y-0.5"
        >
          Create your account
        </Link>
      </div>
